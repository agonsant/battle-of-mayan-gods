...
Quintus.Sprites = function(Q) {
 ...
 /**
   water sprite type 128

   @property Q.SPRITE_WATER
   @for Quintus.Sprites
   @final
  */
  Q.SPRITE_WATER       = 128;
  ...
  /**
   WEAPON sprite type 256

   @property Q.SPRITE_WEAPON
   @for Quintus.Sprites
   @final
  */
  Q.SPRITE_WEAPON       = 256;
    ...
    /**
   DOOR sprite type 512

   @property Q.SPRITE_DOOR
   @for Quintus.Sprites
   @final
  */
  Q.SPRITE_DOOR       = 512;
   ...
   /**
   ENEMY_WEAPON sprite type 1024

   @property Q.SPRITE_ENEMY_WEAPON
   @for Quintus.Sprites
   @final
  */
  Q.SPRITE_ENEMY_WEAPON       = 1024;
  
  
    /**
   ENEMY_BOSS sprite type 2048

   @property Q.SPRITE_ENEMY_BOSS
   @for Quintus.Sprites
   @final
  */
  Q.SPRITE_ENEMY_BOSS = 2048;
